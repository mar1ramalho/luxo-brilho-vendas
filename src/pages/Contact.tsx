        ...
        <div className="container px-4 md:px-6">
          ...
          <div className="mb-12 text-center">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Estamos à disposição para responder suas dúvidas, ouvir sugestões ou ajudar 
              com informações sobre nossos produtos.
            </p>
          </div>
              ...
              <div className="space-y-8">
                ...
                <div>
                  ...
                  <p className="text-gray-600 mb-1">
                    <span className="font-medium">Email:</span> contato@brilhoeterno.com
                  </p>
                  <p className="text-gray-600 mb-1">
          ...
          {/* Map or Store Image */}
          <div className="mt-16">
            <h2 className="text-2xl font-semibold mb-6">Nossa Loja</h2>
